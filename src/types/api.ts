// To parse this data:
//
//   import { Convert, APISpaceResponse } from "./file";
//
//   const aPISpaceResponse = Convert.toAPISpaceResponse(json);
//
...
export class Convert {
    public static toAPISpaceResponse(json: string): APISpaceResponse {
        return cast(JSON.parse(json), r("APISpaceResponse"));
    }

    public static aPISpaceResponseToJson(value: APISpaceResponse): string {
        return JSON.stringify(uncast(value, r("APISpaceResponse")), null, 2);
    }
}
